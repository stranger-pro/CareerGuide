...
export const Features = [
  ...
  },
  {
    ...
    desc: "After analysing your resume, CareerGuide matches you with roles that actually fit your skills and experience — no more applying blindly and wondering why you hear nothing back.",
    bullets: [
...
<div class="footer">Generated by CareerGuide · ${new Date().toLocaleDateString(
    "en-IN",
